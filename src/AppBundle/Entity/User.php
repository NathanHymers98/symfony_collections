...
class User implements UserInterface
{
    ...
    // This entity has a one to many relationship with the GenusScientist entity, this side is the inverse side, and it is being mapped by the $user property inside GenusScientist
    /**
