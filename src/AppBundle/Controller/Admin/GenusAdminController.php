 ...
 * @Route("/admin")
 */
class GenusAdminController extends Controller // This class is what controls the twig view that allows an admin user to create, edit and delete genuses and all their data
{
    /**
